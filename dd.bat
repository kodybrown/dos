...
:usage
	echo.
	echo Lists directories where name contains the value specified.
	echo.
	echo   %~n0
	echo     lists all directories.
	echo   %~n0 abc
	echo     lists directories that contain `abc` in the name.
	echo   %~n0 [options] abc
	echo     lists directories that contain `abc` in the name,
